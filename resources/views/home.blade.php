        ...
        <header>
            <div class="flex justify-center pt-6">
                ...
                <nav class="pointer-events-auto md:block">
                    <ul
                        class="flex rounded-full bg-neutral-800 px-3 text-sm font-medium text-zinc-300 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 border border-neutral-700">
            ...
            <div class="ml-5 mt-16 space-y-8" id="home">
                ...
                <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400 w-full md:w-2/3 pr-5">
                    I'm Germán Lozickyj, a Software Developer and DevOps professional based in Buenos Aires, Argentina. I specialize in crafting solutions using the "TALL" stack and leveraging cloud computing technologies.
    
                    Passionate about tech things, you can explore my posts below.
                </p>
    
                <div class="space-x-5">
                    <!-- LinkedIn -->
                    <a href="https://www.linkedin.com/in/germanlozickyj" target="_blank"><i
                            class="fab fa-linkedin text-zinc-600 dark:text-zinc-400 text-2xl"></i></a>
    
                    <!-- GitHub -->
                    <a href="https://github.com/germanlozickyj" target="_blank"><i
                            class="fab fa-github text-zinc-600 dark:text-zinc-400 text-2xl"></i></a>
    
                    <!-- Twitter -->
                    <a href="https://twitter.com/germanlozickyj" target="_blank"><i
                            class="fab fa-twitter text-zinc-600 dark:text-zinc-400 text-2xl"></i></a>
                                    ...
                                    <ol class="mt-6 space-y-4">
                                        <li class="flex gap-4">
                                            <div
                                                ...
                                                <img src="{{ asset('./assets/snet.jpeg') }}" alt="socialnet s.a" loading="lazy" width="32"
                                                    height="32" decoding="async" data-nimg="1" class="h-7 w-7 rounded-full"
                                            ...
                                            <dl class="flex flex-auto flex-wrap gap-x-2">
                                                ...
                                                <dd class="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                    aria-label="2019 until Present"><time datetime="2021">2024</time> <span
                                                        aria-hidden="true">—</span> <time datetime="2024">Present</time>
                                                </dd>
                                            </dl>
                                        </li>
                                        ...
                                        <li class="flex gap-4">
                                            ...
                                            <dl class="flex flex-auto flex-wrap gap-x-2">
                                                ...
                                                <dt class="sr-only">Date</dt>
                                                <dd class="ml-auto text-xs text-zinc-400 dark:text-zinc-500"
                                                    aria-label="2019 until Present"><time datetime="2021">2021</time> <span
                                                        aria-hidden="true">—</span> <time datetime="2024">2024</time>
                                                </dd>
                                            </dl>
                                        </li>
                                    </ol>
                        ...
                        <div class="relative px-4 sm:px-8 lg:px-12">
                            <div class="mx-auto max-w-2xl lg:max-w-5xl">
                                <div class="flex flex-col items-center justify-between gap-6 sm:flex-row">
                                    ...
                                    <p class="text-sm text-zinc-400 dark:text-zinc-500">© <!-- -->2024<!-- --> Germán
                                        Lozickyj. All rights reserved.</p>
                                </div>
                            </div>
                        </div>
                    </div>
